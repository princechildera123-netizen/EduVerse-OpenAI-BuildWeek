    ...
    <div className="min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(91,95,240,0.18),transparent_32rem),radial-gradient(circle_at_85%_15%,rgba(25,198,192,0.16),transparent_24rem),#f8fbff]">
      <header className="mx-auto flex max-w-7xl items-center justify-between px-4 py-5 sm:px-6 lg:px-8" aria-label="Primary navigation">
        ...
        <nav className="flex items-center gap-2" aria-label="Student and account navigation">
          ...
          <ButtonLink to="/career-advisor" variant="ghost" className="hidden 2xl:inline-flex">Career</ButtonLink>
          <ButtonLink to="/analytics" variant="ghost" className="hidden 2xl:inline-flex">Analytics</ButtonLink>
          <ButtonLink to="/teacher-dashboard" variant="ghost" className="hidden 2xl:inline-flex">Teacher</ButtonLink>
          <ButtonLink to="/parent-dashboard" variant="ghost" className="hidden 2xl:inline-flex">Parent</ButtonLink>
          <ButtonLink to="/admin-dashboard" variant="ghost" className="hidden 2xl:inline-flex">Admin</ButtonLink>
