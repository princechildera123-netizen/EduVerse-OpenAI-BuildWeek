...
const roleDestinations = { student: '/dashboard', teacher: '/teacher-dashboard', parent: '/parent-dashboard', administrator: '/admin-dashboard' } as const;
  ...
  return (
    <div className="py-10 sm:py-16">
      <section className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-4 text-lg leading-8 text-muted">Choose a role to enter the matching mock dashboard experience. Backend integrations are still intentionally deferred.</p>
      </section>
      <div className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {roles.map((role, index) => (
          ...
          >
            ...
            <Link to={roleDestinations[role.id]} className="focus-ring mt-6 block w-full rounded-full border border-slate-200 bg-white px-4 py-3 text-center text-sm font-bold text-brand transition group-hover:border-brand/40">
              Select {role.title}
            </Link>
          </motion.article>
        ))}
