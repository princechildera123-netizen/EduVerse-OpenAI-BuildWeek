...
## Role Dashboards and Authentication

- Teacher dashboard (`/teacher-dashboard`)
- Parent dashboard (`/parent-dashboard`)
- School administrator dashboard (`/admin-dashboard`)
- Mock frontend authentication with persisted sessions, logout, protected routes, and role-based route guards.

## Additional Student AI Routes

- AI Career & University Advisor (`/career-advisor`)
- Smart Study Planner (`/study-planner`)
- AI Notes & Flashcard Generator (`/ai-notes`)
- AI Performance Analytics (`/analytics`)
